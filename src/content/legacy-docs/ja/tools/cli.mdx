...
| `--custom-image` |  | フラグ値として渡されたカスタムイメージでワークスペースを作成する；--custom-image-userフラグも設定する必要がある |
| `--custom-image-user` |  | フラグ値として渡されたカスタムイメージユーザーでワークスペースを作成する；--custom-imageフラグも設定する必要がある |
