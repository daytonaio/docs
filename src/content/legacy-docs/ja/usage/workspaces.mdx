...
GitリポジトリからWorkspaceを作成すると、[接続されたGit Provider](/docs/ja/configuration/git-providers)またはカスタムGitリポジトリURLを使用して新しい開発環境がセットアップされます。
...
<Aside type="tip">
   ...
   これには[Builder](/docs/ja/usage/builders)の設定も含まれます。
</Aside>

<br />

4. WorkspaceをデプロイするTargetを選択します。Targetを選択すると、[Target設定](/docs/ja/configuration/target-config)の入力を求められます。設定は選択されたTargetによって異なります。
...
2. WorkspaceをデプロイするTargetを選択します。Targetを選択すると、[Target設定](/docs/ja/configuration/target-config)の入力を求められます。設定は選択されたTargetによって異なります。
...
<Aside type="tip">
コマンドラインフラグを使用してWorkspace作成時にProject Builderを設定します。詳細については**[Builders](/docs/ja/usage/builders)**を参照してください。
</Aside>
