...
Daytonaでは、カスタムサンプルを使用してワークスペースを作成するオプションを提供しています。カスタムサンプルの作成は、以下の2つのステップからなるプロセスです：
...
カスタムサンプルリポジトリは、サンプルコードと開発環境を定義する`devcontainer.json`ファイルを含むGitリポジトリです。このリポジトリはサンプルの中核コンテンツとして機能し、ワークスペースの作成に使用されます。

1. カスタムサンプルを表すリポジトリを作成します。

2. カスタムサンプルコード、開発設定、依存関係を定義します。

3. 開発環境を定義する**`devcontainer.json`**ファイルを作成します。

- [開発コンテナ標準](https://containers.dev/)を使用して開発環境を定義します。開発コンテナは、サンプル内で使用されるプログラミング言語、設定、ツールによって異なります。

Go プログラミング言語を使用する開発環境の**`devcontainer.json`**ファイルの例：
...
カスタムサンプルは、ワークスペース作成時に利用可能になります。選択されたサンプルはクローンされ、ワークスペースの作成に使用されます。
