...
Daytona SDKは、Sandboxes内の`fs`モジュールを通じて包括的なファイルシステム操作を提供します。本ガイドでは、利用可能なすべてのファイルシステム操作とベストプラクティスについて説明します。

## 基本操作

Daytona SDK は、サンドボックス内のファイルシステムとやり取りするためのオプションを提供します。ファイルの一覧表示、ディレクトリの作成、ファイルの読み書きなど、さまざまな操作を実行できます。

### ファイルとディレクトリの一覧表示

Daytona SDK は、Python および TypeScript を使用してサンドボックス内のファイルやディレクトリを一覧表示するオプションを提供します。
...
Daytona SDK は、Python および TypeScript を使用して特定のパーミッションでディレクトリを作成するオプションを提供します。
...
Daytona SDK は、Python および TypeScript を使用してサンドボックス内のファイルの読み取り、書き込み、アップロード、ダウンロード、削除のオプションを提供します。
...
Daytona SDK は、ファイルのパーミッション設定、検索と置換などの高度なファイルシステム操作を提供します。

### ファイルパーミッション

Daytona SDK では、Python および TypeScript を使用してファイルのパーミッション設定、パーミッションの取得、ディレクトリのパーミッションを再帰的に設定することができます。
...
Daytona SDK では、Python および TypeScript を使用してファイル内のテキスト検索やテキストの置換を行うことができます。
