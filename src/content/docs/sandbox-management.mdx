...
The `auto_stop_interval` parameter sets the amount of time after which a running Sandbox will be automatically stopped.
...
The `auto_archive_interval` parameter sets the amount of time after which a stopped Sandbox will be automatically archived.
