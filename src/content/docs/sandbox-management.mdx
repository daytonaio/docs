...
A Daytona Sandbox can have three states during its lifetime: [Started](#creating-sandboxes), [Stopped](#stop-and-start-sandbox) and [Archived](#archive-sandbox). The diagram below shows the states and possible transitions between them.
