...
You can configure the compute resources allocated to your Sandbox using the `SandboxResources` class. This allows you to specify CPU cores, memory, disk space, and GPU allocation.
...
Daytona SDK provides method to get the preview port for the Sandbox.
