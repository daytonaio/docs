...
Project Configuration is designed to simplify the management of development environments, allowing you to predefine settings that can be easily applied to any new or existing Workspace.
...
- **Environment Variables**
   ...
   Environment variables specified in the `KEY=VALUE` format. These variables are essential for the Project's build and runtime environments. You can set these variables directly or pass them from the machine's environment during execution.
