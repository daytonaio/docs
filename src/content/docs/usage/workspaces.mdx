...
The Workspace Toolbox enables you to interact with the Workspace programmatically, providing an API to perform various operations within the Workspace environment.
