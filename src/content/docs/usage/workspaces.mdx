...
The Workspace Toolbox enables you to interact with the Workspace programmatically by providing an API to perform various operations within the Workspace environment.

The Workspace Toolbox provides FileSystem, Git, LSP, and Process operations, allowing you to manage files, execute Git commands, interact with Language Server Protocol (LSP) services, and run processes within the Workspace.

It utilizes Headless IDE to provide a seamless development experience, enabling you to perform operations directly within the Workspace environment.
