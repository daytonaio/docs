...
Daytona allows you to create a Workspace with multiple projects, enabling you to work on multiple codebases simultaneously within a single environment.
...
- The [Docker Provider](/docs/configuration/providers#docker) deploys projects within the same container.
