...
After setting the default IDE, it will be opened automatically and connected to your Workspace when using the `daytona open` command.
...
:::note
When using the `daytona open` command with `VS Code - Browser` as your default IDE, Daytona will set up an instance of OpenVSCode Server on your local machine.
Following successful set up, Visual Studio Code will automatically open in your default browser and connect to your Workspace.
:::