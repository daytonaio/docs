...
:::note
Install [Cursor](https://www.cursor.com/) and ensure it is in your `PATH`.

After installing the Cursor IDE, run the `Install 'cursor' command` from the command palette.
:::
