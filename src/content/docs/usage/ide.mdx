...
Daytona allows you to connect to your Workspace using Visual Studio Code Insiders IDE.
...
Daytona allows you to connect to your Workspace using VSCodium IDE.
...
Daytona allows you to connect to your [Workspace Toolbox](/docs/usage/workspaces#workspace-toolbox) using a Headless IDE.
...
Daytona allows you to connect to your Workspace using Windsurf IDE.
