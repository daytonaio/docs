...
You can set the default IDE to connect to your Workspace used by Daytona.
...
1. Run the following command to set your default IDE to JetBrains CLion IDE:
...
1. Run the following command to set your default IDE to JetBrains GoLand IDE:
...
1. Run the following command to set your default IDE to JetBrains IntelliJ IDEA Ultimate IDE:
...
1. Run the following command to set your default IDE to JetBrains PhpStorm IDE:
...
1. Run the following command to set your default IDE to JetBrains PyCharm Professional IDE:
...
1. Run the following command to set your default IDE to JetBrains Rider IDE:
...
1. Run the following command to set your default IDE to JetBrains RubyMine IDE:
...
1. Run the following command to set your default IDE to JetBrains WebStorm IDE:
...
Daytona allows you to connect to your Workspace using Terminal SSH.
...
2. Select `Terminal SSH` from the list presented. Upon selecting, Daytona will set it as the default IDE and display a confirmation message.
    ...
    You can now use the `daytona code` command to automatically open the Terminal SSH already connected to your Workspace.
