...
- **Local Builder Registry Port**
    ...
    The Local Builder Registry Port property can be manually edited to use a different local builder registry port.
...
- **Local Builder Registry Image**
    ...
    The Local Builder Registry Image property can be manually edited to use a different local builder registry image.
