...
2. Select the Prebuild you want to view.
   ...
   Upon selecting the Prebuild, Daytona will display the details of the selected Prebuild. You will be able to view the Prebuild ID, the branch it is linked to, the commit interval, the trigger files, and the build retention.
...
1. Run the following command to update a Prebuild:
   ...
   Upon running this command, Daytona will display a list of your Prebuilds to update.
...
2. Select the Prebuild you want to update.
   ...
   Upon selecting the Prebuild, Daytona will prompt you to update the commit interval, trigger files, and build retention.
...
1. Run the following command to delete a Prebuild:
   ...
   Upon running this command, Daytona will display a list of your Prebuilds to delete.
