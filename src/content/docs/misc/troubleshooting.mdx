...
:::tip
For automated setup, create a **`windows/vscode_wsl_ssh.sh`** script including execution of the steps outlined above, and detection of the WSL distribution by checking if the output of `uname -a` contains "Microsoft" or "WSL".
:::
