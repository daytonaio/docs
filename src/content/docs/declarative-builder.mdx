...
It provides the following capabilities. For a complete API reference and method signatures, check the [Python](/docs/python-sdk/image) and [TypeScript](/docs/typescript-sdk/image) SDK references.
...
For detailed method signatures and usage examples, refer to the [Python](/docs/python-sdk/image) and [TypeScript](/docs/typescript-sdk/image) SDK references.
