...
Similarly to file operations the starting cloning dir is the current Sandbox user's root - e.g. `/workspace/repo` implies `/home/[username]/workspace/repo`, but you are free to provide an absolute workdir path as well.
