...
```powershell
# x86-64
curl -sf -L https://download.daytona.io/daytona/v0.21/daytona-windows-amd64.exe -o daytona
# AArch64
curl -sf -L https://download.daytona.io/daytona/v0.21/daytona-windows-arm64.exe -o daytona
```
