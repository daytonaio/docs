...
```shell
# for Linux (x86-64)
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-linux-amd64 -o daytona
# for Linux (AArch64)
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-linux-arm64 -o daytona
# for macOS (x86-64/Intel-based)
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-darwin-amd64 -o daytona
# for macOS (AArch64/Apple Silicon)
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-darwin-arm64 -o daytona
```
:::
...
```powershell
# x86-64
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-windows-amd64.exe -o daytona
# AArch64
curl -sf -L https://download.daytona.io/daytona/v0.14.0/daytona-windows-arm64.exe -o daytona
```
:::
