...
```shell
# x86-64
curl -sf -L https://download.daytona.io/daytona/v0.41/daytona-linux-amd64 -o daytona
# AArch64
curl -sf -L https://download.daytona.io/daytona/v0.41/daytona-linux-arm64 -o daytona
```
...
```shell
# x86-64/Intel-based
curl -sf -L https://download.daytona.io/daytona/v0.41/daytona-darwin-amd64 -o daytona
# AArch64/Apple Silicon
curl -sf -L https://download.daytona.io/daytona/v0.41/daytona-darwin-arm64 -o daytona
```
