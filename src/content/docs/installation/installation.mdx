...
After installing Daytona using the best method for your environment, you can [create a Workspace](/docs/usage/workspaces#create-a-workspace), [add a Git Provider](/docs/configuration/git-providers#add-a-git-provider), [install a Provider](/docs/configuration/providers#install-a-provider), and [use the CLI reference](/docs/tools/cli) to understand Daytona's full array of functionality.
...
```shell
# x86-64
curl -sf -L https://download.daytona.io/daytona/v0.43/daytona-linux-amd64 -o daytona
# AArch64
curl -sf -L https://download.daytona.io/daytona/v0.43/daytona-linux-arm64 -o daytona
```
...
```shell
# x86-64/Intel-based
curl -sf -L https://download.daytona.io/daytona/v0.43/daytona-darwin-amd64 -o daytona
# AArch64/Apple Silicon
curl -sf -L https://download.daytona.io/daytona/v0.43/daytona-darwin-arm64 -o daytona
```
