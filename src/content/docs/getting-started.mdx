...
:::tip
You can access the Sandbox [Web Terminal](/docs/other#web-terminal) by printing out the preview URL for port `22222` or by simply going to Dashboard -> Sandboxes and clicking on the Terminal input sign.
:::
