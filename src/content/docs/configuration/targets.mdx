...
Change this by running `daytona target set-default` and selecting the Target Configuration you want or override it directly by using the `--target` flag when running `daytona create`.
:::
