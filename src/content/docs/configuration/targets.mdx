...
```text
Zone
The zone where the instance will be created. Default is us-central1-a.
>

Machine Type
The type of machine to create. Default is n1-standard-1.
>

Disk Type
The type of disk to create. Default is pd-standard.
>

Disk Size
The size of the disk in GB. Default is 20.
>

VM Image
The image to use for the VM. Default is projects/ubuntu-os-cloud/global/images/family/ubuntu-2204-lts.
>

Credential File
The path to the GCP credential file.
>
