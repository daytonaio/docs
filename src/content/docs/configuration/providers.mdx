...
1.  __Provider__  
    A platform capable of deploying Workspaces on.
    Examples of Providers may include:
    *   Container management platforms such as Docker and Podman;
...
2.  __Target__  
    ...
    Daytona allows you to configure and switch between multiple Targets at Workspace creation time.
