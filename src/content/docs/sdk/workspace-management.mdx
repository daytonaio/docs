...
Daytona provides a simple interface for creating workspaces with default configurations. You can create a Workspace with a specific language, custom ID, or default settings.
