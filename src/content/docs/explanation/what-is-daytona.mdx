...
Daytona allows you to manage and deploy reproducible Development Environments (DEs) based on standard OCI containers, leveraging the Dev Container standard.

By leveraging configuration in a project's remote Git repository, Daytona builds a DE, pulls in project dependencies and packages, and provisions a workspace to a platform of your choice.
...
*   __Extensible Core__  
    Daytona supports plugins and development of third-party Git Providers in any dynamic programming language.
