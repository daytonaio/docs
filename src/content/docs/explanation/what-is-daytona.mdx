...
description: Understand how Daytona can help you manage your Workspaces.
sidebar:
  label: What is Daytona?
---

Daytona is an open-source Development Environment Manager (DEM) licensed under the Apache License 2.0.
Daytona allows you to manage and deploy reproducible Workspaces (Dev Environments) based on standard OCI containers, with built-in support for the Dev Container standard.
