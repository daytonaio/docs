...
スナップショットは、Daytona Sandboxに必要なすべての依存関係、ツール、環境設定、リソース要件を含む事前設定済みのテンプレートです。Daytonaは、すべての標準的な[Docker](https://www.docker.com/)または[OCI](https://opencontainers.org/)互換イメージからのスナップショット作成をサポートしています。
