...
AI Agentのための最初のDaytona Sandboxを作成して実行するためのステップバイステップガイドに従ってください。
...
このエンドポイントにプログラムでアクセスする必要がありますか？[Preview & Authentication](/docs/ja/preview-and-authentication)について詳しく学びましょう。

:::tip
ポート`22222`のプレビューURLを出力するか、単にDashboard -> Sandboxesに移動してTerminal入力サインをクリックすることで、Sandbox [Web Terminal](/docs/ja/web-terminal)にアクセスできます。
:::
