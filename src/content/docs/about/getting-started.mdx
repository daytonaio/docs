...
<<<<<<< #133-add-cursor-ide
Daytona allows you to connect to your development environment using a variety of [IDEs](/usage/ide), including popular options like [Visual Studio Code (VSCode)](/usage/ide#vs-code), JetBrains IDEs, [Cursor](/usage/ide#cursor), and [Terminal SSH](/usage/ide#terminal-ssh).
=======
