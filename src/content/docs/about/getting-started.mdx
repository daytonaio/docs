...
Daytona provides an API that allows you to interact with the platform programmatically. The API offers a set of endpoints that enable you to perform various actions, such as creating Workspaces, managing Providers, setting Targets, and configuring system settings.

To access the Daytona API, you can use the Daytona CLI or interact with the API directly using HTTP requests. The API endpoints are designed to provide flexibility and control over the Daytona platform. By integrating with the API, you can automate tasks, streamline workflows, and extend the functionality of Daytona to suit your specific requirements.

For more information on the Daytona API and available endpoints, refer to the [API Reference](/reference/api). This reference guide provides detailed information on each API endpoint, including request parameters, response formats, and usage examples.

<DocumentList>
<DocumentListItem
    title="API Reference"
    subtitle="Learn how to interact with the Daytona API to manage your development environments programmatically."
    href="/reference/api"
    expanded
  />
</DocumentList>
