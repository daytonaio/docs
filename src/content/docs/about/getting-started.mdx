...
For a complete list of available commands, refer to the [CLI Reference](/docs/reference/cli). The CLI reference guide provides detailed information on each command, including usage examples and command options, helping you leverage the full potential of Daytona.
...
Daytona supports a variety of Providers, including [Docker](/docs/configuration/providers#docker), [AWS](/docs/configuration/providers#aws), [DigitalOcean](/docs/configuration/providers#digitalocean), and [Fly](/docs/configuration/providers#fly)
...
Daytona supports a variety of Targets, including [Docker (Local)](/docs/configuration/targets#docker), [Docker (Remote)](/docs/configuration/targets#docker), [AWS](/docs/configuration/targets#aws), [DigitalOcean](/docs/configuration/targets#digitalocean), and [Fly](/docs/configuration/targets#fly).
...
Connect to your development environment using a variety of [IDEs](/docs/usage/ide), including popular options like [Visual Studio Code (VSCode)](/docs/usage/ide#vs-code), JetBrains IDEs, [Jupyter](/docs/usage/ide#jupyter), [Cursor](/docs/usage/ide#cursor), and [Terminal SSH](/docs/usage/ide#terminal-ssh).
