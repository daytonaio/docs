...
For simplicity, all file operations by default assume you are operating in the root directory of the Sandbox user - e.g. `/workspace` implies `/home/[username]/workspace`, but you are free to provide an absolute workdir path as well.
